...
return [
    'GET' => [
        ...
        'combos'             => ['controller' => 'ComboController',          'method' => 'index',             'middleware' => ['auth']],
        'combos/create'      => ['controller' => 'ComboController',          'method' => 'create',            'middleware' => ['auth', 'admin']],
        'combos/edit'        => ['controller' => 'ComboController',          'method' => 'edit',              'middleware' => ['auth', 'admin']],
        ...
        'complaints/create'  => ['controller' => 'ComplaintController',      'method' => 'create',            'middleware' => ['auth']],
    ...
    'POST' => [
        ...
        'combos/store'         => ['controller' => 'ComboController',          'method' => 'store',         'middleware' => ['auth', 'admin']],
        'combos/update'        => ['controller' => 'ComboController',          'method' => 'update',        'middleware' => ['auth', 'admin']],
        'combos/delete'        => ['controller' => 'ComboController',          'method' => 'delete',        'middleware' => ['auth', 'admin']],
        ...
        'complaints/store'     => ['controller' => 'ComplaintController',      'method' => 'store',         'middleware' => ['auth']],
        'complaints/delete'    => ['controller' => 'ComplaintController',      'method' => 'delete',        'middleware' => ['auth', 'admin']],
